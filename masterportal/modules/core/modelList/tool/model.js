...
const Tool = Item.extend(/** @lends Tool.prototype */{
    defaults: {
        ...
        supportedIn3d: ["supplyCoord", "gfi", "wfsFeatureFilter", "searchByCoord", "legend", "contact", "saveSelection", "parcelSearch", "coordToolkit", "print"],
        supportedOnlyIn3d: ["shadow", "modeler3D"],
